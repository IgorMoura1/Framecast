...
const data = [
    { name: "./assets/aerial-flying-soot-toumba.mp4" },
    { name: "./assets/aerial-following-car.mp4" },
    { name: "./assets/brunette-submerged.mp4" },
    { name: "./assets/lava-flows-after-sunset-ocean.mp4" },
    { name: "./assets/red-car.mp4", },
    { name: "./assets/space-cat-girl.mp4", },
    { name: "./assets/sunset-pink-and-purple-cumulus.mp4", },
    { name: "./assets/young-girl-salon-make.mp4", },
];
...
function animate() {
    ...
    const targetTransform = `translate(-50%, -50%)
        perspective(1000px)
        rotateX(${headerRotationX}deg)
        rotateY(${headerRotationY}deg)
        translateZ(${headerTranslateZ}px)`;

    header.computedStyleMap.transform = targetTransform;
    header.computedStyleMap.transtition = "transform 0.5s cubic-bezier(0.215, 0.61, 0.355, 1)";
